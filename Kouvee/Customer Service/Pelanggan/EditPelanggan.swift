...
import UIKit
import Alamofire
class EditPelanggan: UIViewController ,UITextFieldDelegate {
    ...
    @IBAction func btnSubmit(_ sender: Any) {
        if txtNama.text != "" && txtNomor.text != "" && txtAlamat.text != "" && txtTanggal.text != "" {
    ...
    override func viewDidLoad() {
        ...
        txtNama.text = Pelanggans?.nama_pelanggan
        txtAlamat.text = Pelanggans?.alamat_pelanggan
        txtNomor.text = Pelanggans?.phone_pelanggan
        txtTanggal.text = Pelanggans?.tgl_lahir_pelanggan
    ...
    fileprivate func edit(nama: String, alamat: String, nomor: String, tanggal: String, id_pegawai: String){
        ...
        guard let url = URL(string: urlPelanggan + self.Pelanggans!.id_pelanggan ) else { return }
