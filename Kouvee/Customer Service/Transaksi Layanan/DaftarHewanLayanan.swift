...
import UIKit
import Alamofire
class DaftarHewanLayanan: UIViewController , UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UISearchBarDelegate{
    ...
    let URL_Transaksi = "http://kouvee.xyz/index.php/TransaksiLayanan"
    ...
    @IBAction func btnAdd(_ sender: Any) {
        Info.sharedInstance.status = "layanan"
        print(Info.sharedInstance.status,"kkkk")
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if(filtered.count > 0){
            ...
            infoTransaksiLayanan.sharedInstance.id_hewan = Hewan.id_hewan
            infoTransaksiLayanan.sharedInstance.nama_hewan = Hewan.nama_hewan
            infoTransaksiLayanan.sharedInstance.id_pelanggan = Hewan.id_pelanggan
            infoTransaksiLayanan.sharedInstance.nama_pelanggan = Hewan.nama_pelanggan
            infoTransaksiLayanan.sharedInstance.id_pegawai = Info.sharedInstance.id_pegawai
            infoTransaksiLayanan.sharedInstance.nama_pegawai = Info.sharedInstance.nama_pegawai
            self.post()
    ...
    fileprivate func post(){
        ...
        let parameters: [String: Any] = ["id_pegawai" :infoTransaksiLayanan.sharedInstance.id_pegawai,
                                    "id_hewan" : infoTransaksiLayanan.sharedInstance.id_hewan,
                                    "peg_id_pegawai" : "4"]
            ...
            if err != nil{
                ...
                if let useable = data{
                    do{
                        ...
                        infoTransaksiLayanan.sharedInstance.lastID = self.TransaksiL[0].id_transaksi_layanan
                        print(infoTransaksiLayanan.sharedInstance.lastID)
                    }
                    catch{
                        print("catch error")
                    }
