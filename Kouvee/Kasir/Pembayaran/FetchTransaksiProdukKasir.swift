...
import UIKit
import Alamofire
class FetchTransaksiProdukKasir: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UISearchBarDelegate{
   ...
   private let refreshControl = UIRefreshControl()
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "lihatDetailProduk"{
            guard let VC = segue.destination as? ViewTransaksiProdukKasir else {return}
