...
class EditPegawai: UIViewController ,UITextFieldDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
...
var urlPegawai = "http://www.kouvee.xyz/index.php/Pegawai/"
    ...
    override func viewDidLoad() {
        ...
        txtNama.text = Employee?.nama_pegawai
        txtAlamat.text = Employee?.alamat_pegawai
        txtNomor.text = Employee?.phone_pegawai
        labelID.text = Employee!.id_pegawai
        txtTanggal.text = Employee!.tgl_lahir_pegawai
        txtJabatan.text = Employee!.jabatan
       
        pickerTgl.datePickerMode = .date
        pickerTgl.addTarget(self, action: #selector(EditPegawai.dateChanged(datePicker: )), for: .valueChanged)
...
func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
    ...
    fileprivate func edit(nama: String, alamat: String, nomor: String, tgl: String, jabatan: String){
    ...
    guard let url = URL(string: urlPegawai + self.Employee!.id_pegawai ) else { return }
