...
class EditUkuran: UIViewController, UITextFieldDelegate {
     ...
     var urlUkuran = "http://www.kouvee.xyz/index.php/Ukuran/"
         ...
         @IBAction func btnSubmit(_ sender: Any) {
             if txtNamaUkuran.text != "" {
                     ...
                     alert.addAction(UIAlertAction(title: "Ok", style: .default, handler:{ (UIAlertAction) in
                        ...
                        self.edit(nama_ukuran: self.txtNamaUkuran.text!, id_pegawai: Info.sharedInstance.id_pegawai)
         ...
         override func viewDidLoad() {
             ...
             txtNamaUkuran.text = Ukurans?.ukuran
     ...
     fileprivate func edit(nama_ukuran: String, id_pegawai: String){
         
         let parameters: [String: Any] = ["ukuran" :nama_ukuran, "id_pegawai" :id_pegawai]
         
         guard let url = URL(string: urlUkuran + self.Ukurans!.id_ukuran ) else { return }
