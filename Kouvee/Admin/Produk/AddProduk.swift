...
class AddProduk: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate {
            ...
            if txtNamaProduk.text != ""
                ...
                && imgProduk.image != nil{
                    ...
                    alert.addAction(UIAlertAction(title: "Ok", style: .default, handler:{ (UIAlertAction) in
                        self.post(nama: self.txtNamaProduk.text!,
        ...
        func origionalImage(origionalImage: UIImage!) {
            ...
            let imageName = self.nama_img as String
    ...
    func post(nama:String, id_peg:String, stock: String, min_stock:String, satuan:String, beli:String, jual:String) {
      let parameters = [
        "nama_produk" : nama,
        "id_pegawai":id_peg,
        "stock":stock,
